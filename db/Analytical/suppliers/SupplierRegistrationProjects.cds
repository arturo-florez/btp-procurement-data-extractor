...
entity SupplierRegistrationProjects_AN : managed {
    ...
    key ProjectId                   : String(50);
        ...
        Region                      : Composition of many SupplierRegistrationProjects_Region_AN
                                          on Region.SupplierRegistrationProject = $self;
        Commodity                   : Composition of many SupplierRegistrationProjects_Commodity_AN
                                          on Commodity.SupplierRegistrationProject = $self;
        Organization                : Composition of many SupplierRegistrationProjects_Organization_AN
                                          on Organization.SupplierRegistrationProject = $self;
        AllOwners                   : Composition of many SupplierRegistrationProjects_AllOwners_AN
                                          on AllOwners.SupplierRegistrationProject = $self;
