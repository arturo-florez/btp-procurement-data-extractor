...
entity SMProjectQuestionnaireResponses_AN : managed {
    ...
    key VersionNumber            : Double;
        ...
        ResponseCommodityValue   : Composition of many SMProjectQuestionnaireResponses_ResponseCommodityValue_AN
                                       on ResponseCommodityValue.SMProjectQuestionnaireResponse = $self;
        ResponseRegionValue      : Composition of many SMProjectQuestionnaireResponses_ResponseRegionValue_AN
                                       on ResponseRegionValue.SMProjectQuestionnaireResponse = $self;
        ResponseDepartmentValue  : Composition of many SMProjectQuestionnaireResponses_ResponseDepartmentValue_AN
                                       on ResponseDepartmentValue.SMProjectQuestionnaireResponse = $self;
        ResponseSupplierValue    : Composition of many SMProjectQuestionnaireResponses_ResponseSupplierValue_AN
                                       on ResponseSupplierValue.SMProjectQuestionnaireResponse = $self;
        V_responsetextmultivalue : Composition of many SMProjectQuestionnaireResponses_V_responsetextmultivalue_AN
                                       on V_responsetextmultivalue.SMProjectQuestionnaireResponse = $self;
}
