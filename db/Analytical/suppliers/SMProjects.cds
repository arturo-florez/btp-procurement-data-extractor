...
entity SMProjects_AN : managed {
    ...
    key ProjectId                   : String(50);
        ...
        Region                      : Composition of many SMProjects_Region_AN
                                          on Region.SMProject = $self;
        Commodity                   : Composition of many SMProjects_Commodity_AN
                                          on Commodity.SMProject = $self;
        Organization                : Composition of many SMProjects_Organization_AN
                                          on Organization.SMProject = $self;
        AllOwners                   : Composition of many SMProjects_AllOwners_AN
                                          on AllOwners.SMProject = $self;
