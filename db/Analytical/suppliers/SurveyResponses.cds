...
entity SurveyResponse_AN : managed {
    ...
    key QuestionSourceSystem      : String(100);
        ...
        Commodity                 : Composition of many SurveyResponse_Commodity_AN
                                        on Commodity.SurveyResponse = $self;
        Region                    : Composition of many SurveyResponse_Region_AN
                                        on Region.SurveyResponse = $self;
        Department                : Composition of many SurveyResponse_Department_AN
                                        on Department.SurveyResponse = $self;

        ResponseCommodityValue    : Composition of many SurveyResponse_ResponseCommodityValue_AN
                                        on ResponseCommodityValue.SurveyResponse = $self;
        ResponseRegionValue       : Composition of many SurveyResponse_ResponseRegionValue_AN
                                        on ResponseRegionValue.SurveyResponse = $self;
        ResponseDepartmentValue   : Composition of many SurveyResponse_ResponseDepartmentValue_AN
                                        on ResponseDepartmentValue.SurveyResponse = $self;
        ResponseSupplierValue     : Composition of many SurveyResponse_ResponseSupplierValue_AN
                                        on ResponseSupplierValue.SurveyResponse = $self;
        ResponseUserValue         : Composition of many SurveyResponse_ResponseUserValue_AN
                                        on ResponseUserValue.SurveyResponse = $self;
        V_responsetextmultivalue  : Composition of many SurveyResponse_V_responsetextmultivalue_AN
                                        on V_responsetextmultivalue.SurveyResponse = $self;
