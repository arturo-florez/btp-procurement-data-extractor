...
*/
entity ContractItem_AN : managed, types.customFields {
    ...
    key Realm                              : String(50);
        ...
        CommodityEscalationClause          : Composition of many ContractItem_CommodityEscalationClause
                                                 on CommodityEscalationClause.ContractItem = $self;
        ItemCommodity                      : Composition of many ContractItem_ItemCommodity
                                                 on ItemCommodity.ContractItem = $self;
}

entity ContractItem_ItemCommodity : cuid {
    ItemCommodity : types.commodity;
    ContractItem  : Association to ContractItem_AN;
}
