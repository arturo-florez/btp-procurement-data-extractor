...
entity Projects_AN : managed, types.customFields {
    ...
    key ProjectId        : String(50);
        ...
        Commodity        : Composition of many Projects_Commodity_AN
                               on Commodity.Projects = $self;
        Organization     : Composition of many Projects_Organization_AN
                               on Organization.Projects = $self;
        Region           : Composition of many Projects_Region_AN
                               on Region.Projects = $self;
        AllOwners        : Composition of many Projects_AllOwners_AN
                               on AllOwners.Projects = $self;
