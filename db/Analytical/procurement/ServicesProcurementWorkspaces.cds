...
entity ServicesProcurementWorkspaces_AN : managed, types.customFields {
    ...
    key ProjectId            : String(50);
        ...
        Commodity            : Composition of many ServicesProcurementWorkspaces_Commodity_AN
                                   on Commodity.ServicesProcurementWorkspaces = $self;
        Organization         : Composition of many ServicesProcurementWorkspaces_Organization_AN
                                   on Organization.ServicesProcurementWorkspaces = $self;
        Region               : Composition of many ServicesProcurementWorkspaces_Region_AN
                                   on Region.ServicesProcurementWorkspaces = $self;
        AllOwners            : Composition of many ServicesProcurementWorkspaces_AllOwners_AN
                                   on AllOwners.ServicesProcurementWorkspaces = $self;
        Suppliers            : Composition of many ServicesProcurementWorkspaces_Suppliers_AN
                                   on Suppliers.ServicesProcurementWorkspaces = $self;
