...
entity UserData_AN {
    ...
    key SourceSystem              : String(255) @description: 'Source System';
        ...
        ManagerIdL1               : String(255) @description: 'ManagerIdL1';
        ...
        ManagerIdL2               : String(255) @description: 'ManagerIdL2';
        ManagerIdL3               : String(255) @description: 'ManagerIdL3';
        ManagerIdL4               : String(255) @description: 'ManagerIdL4';
        ManagerIdL5               : String(255) @description: 'ManagerIdL5';
        ManagerIdL6               : String(255) @description: 'ManagerIdL6';
        ManagerIdL7               : String(255) @description: 'ManagerIdL7';
        ManagerIdL8               : String(255) @description: 'ManagerIdL8';
        ManagerIdL9               : String(255) @description: 'ManagerIdL9';
        ManagerIdL10              : String(255) @description: 'ManagerIdL10';
        ManagerIdL11              : String(255) @description: 'ManagerIdL11';
        ManagerIdL12              : String(255) @description: 'ManagerIdL12';
