...
entity Approval_AN : managed {
    ...
    key Approver                                : String(255);
        ...
        Delegatees                              : Composition of many Approval_Delegatees_AN
                                                      on Delegatees.Approval = $self;
        ApprovalRecordUser                      : types.user;
    key Realm                                   : String(25);

}

entity Approval_Delegatees_AN : cuid {
    Delegatees : types.user;
    Approval   : Association to Approval_AN;
}
