...
entity ContractWorkspaces_OP : managed {
    ...
    key InternalId                                           : String(200);
        ...
        AllOwners                                            : Composition of many ContractWorkspaces_AllOwners_OP
                                                                   on AllOwners.ContractWorkspaces = $self;
        ComplexSpendReleaseCreators                          : Composition of many ContractWorkspaces_ComplexSpendReleaseCreators_OP
                                                                   on ComplexSpendReleaseCreators.ContractWorkspaces = $self;

        ComplexSpendReleaseApprovers                         : Composition of many ContractWorkspaces_ComplexSpendReleaseApprovers_OP
                                                                   on ComplexSpendReleaseApprovers.ContractWorkspaces = $self;
        NoticeEmailRecipients                                : Composition of many ContractWorkspaces_NoticeEmailRecipients_OP
                                                                   on NoticeEmailRecipients.ContractWorkspaces = $self;
        AdhocSpendUsers                                      : Composition of many ContractWorkspaces_AdhocSpendUsers_OP
                                                                   on AdhocSpendUsers.ContractWorkspaces = $self;
        ContractPublishingSupplierClassification             : types.alwaysnull;
        ExpiringEmailRecipients                              : Composition of many ContractWorkspaces_ExpiringEmailRecipients_OP
                                                                   on ExpiringEmailRecipients.ContractWorkspaces = $self;
        NotificationProfiles                                 : Composition of many ContractWorkspaces_NotificationProfiles_OP
                                                                   on NotificationProfiles.ContractWorkspaces = $self;
        Client                                               : Composition of many ContractWorkspaces_Client_OP
                                                                   on Client.ContractWorkspaces = $self;
        Region                                               : Composition of many ContractWorkspaces_Region_OP
                                                                   on Region.ContractWorkspaces = $self;
        AffectedParties                                      : Composition of many ContractWorkspaces_AffectedParties_OP
                                                                   on AffectedParties.ContractWorkspaces = $self;
        Commodity                                            : Composition of many ContractWorkspaces_Commodity_OP
                                                                   on Commodity.ContractWorkspaces = $self;
}

entity ContractWorkspaces_AllOwners_OP : cuid {
    key ContractWorkspaces : Association to ContractWorkspaces_OP;
