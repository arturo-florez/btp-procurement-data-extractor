...
entity Requisition_OP : managed, types.customFields {
    ...
    key UniqueName                      : String(50);
        ...
        ApprovalRecords                 : Composition of many Requisition_ApprovalRecords_OP
                                              on ApprovalRecords.Requisition = $self;
        ApprovalRequests                : Composition of many Requisition_ApprovalRequests_OP
                                              on ApprovalRequests.Requisition = $self;
        LineItems                       : Composition of many Requisition_LineItem_OP
                                              on LineItems.Requisition = $self;
...
entity Requisition_ApprovalRequests_OP : cuid {
    key Requisition                     : Association to Requisition_OP;
        ...
        Approvers                       : Composition of many Requisition_ApprovalRequests_Approver_OP
                                              on Approvers.RequisitionApprovalRequests = $self;
...
entity Requisition_LineItem_OP : cuid {
    key Requisition                        : Association to Requisition_OP;
        ...
        SplitAccountings                   : Composition of many Requisition_LineItem_SplitAccountings_OP
