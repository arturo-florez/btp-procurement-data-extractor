...
entity InvoiceReconciliation_OP : managed, types.customFields {
    ...
    key UniqueName                      : String(50);
        ...
        ApprovalRequests                : Composition of many InvoiceReconciliation_ApprovalRequests_OP
                                              on ApprovalRequests.InvoiceReconciliation = $self;
        ApprovalRecords                 : Composition of many InvoiceReconciliation_ApprovalRecords_OP
                                              on ApprovalRecords.InvoiceReconciliation = $self;
        LineItems                       : Composition of many InvoiceReconciliation_LineItem_OP
                                              on LineItems.InvoiceReconciliation = $self;
        Payments                        : Composition of many InvoiceReconciliation_Payments_OP
                                              on Payments.InvoiceReconciliation = $self;
        Exceptions                      : Composition of many InvoiceReconciliation_Exceptions_OP
                                              on Exceptions.InvoiceReconciliation = $self;
        Records                         : Composition of many InvoiceReconciliation_Records_OP
                                              on Records.InvoiceReconciliation = $self;
        RejectionReasons                : Composition of many InvoiceReconciliation_RejectionReasons_OP
                                              on RejectionReasons.InvoiceReconciliation = $self;
...
entity InvoiceReconciliation_ApprovalRequests_OP : cuid {
    key InvoiceReconciliation           : Association to InvoiceReconciliation_OP;
        ...
        Approvers                       : Composition of many InvoiceReconciliation_ApprovalRequests_Approver_OP
                                              on Approvers.InvoiceReconciliationApprovalRequests = $self;
...
entity InvoiceReconciliation_LineItem_OP : cuid {
    key InvoiceReconciliation       : Association to InvoiceReconciliation_OP;
        ...
        SplitAccountings            : Composition of many InvoiceReconciliation_LineItem_SplitAccountings_OP
                                          on SplitAccountings.LineItem = $self;
        Exceptions                  : Composition of many InvoiceReconciliation_LineItem_Exceptions_OP
                                          on Exceptions.LineItem = $self;
