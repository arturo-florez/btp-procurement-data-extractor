...
entity Invoice_OP : managed, types.customFields {
    key Realm                           : String(50);
    key UniqueName                      : String(50);
        ...
        ApprovalRequests                : Composition of many Invoice_ApprovalRequests_OP
                                              on ApprovalRequests.Invoice = $self;
        ApprovalRecords                 : Composition of many Invoice_ApprovalRecords_OP
                                              on ApprovalRecords.Invoice = $self;
        LineItems                       : Composition of many Invoice_LineItem_OP
                                              on LineItems.Invoice = $self;

}

entity Invoice_ApprovalRecords_OP : cuid {
    key Invoice           : Association to Invoice_OP;
...
entity Invoice_ApprovalRequests_OP : cuid {
    key Invoice                         : Association to Invoice_OP;
        ...
        Approvers                       : Composition of many Invoice_ApprovalRequests_Approver_OP
                                              on Approvers.InvoiceApprovalRequests = $self;
}

entity Invoice_ApprovalRequests_Approver_OP : cuid {
    key InvoiceApprovalRequests : Association to Invoice_ApprovalRequests_OP;
        UniqueName              : String(255);
        PasswordAdapter         : String(50);
}

entity Invoice_LineItem_OP : cuid {
    key Invoice                            : Association to Invoice_OP;
        ...
        SplitAccountings                   : Composition of many Invoice_LineItem_SplitAccountings_OP
                                                 on SplitAccountings.LineItem = $self;

}

entity Invoice_LineItem_SplitAccountings_OP : cuid {
    key LineItem           : Association to Invoice_LineItem_OP;
        PONumber           : String(50);
