...
entity PurchaseOrder_OP : managed, types.customFields {
    ...
    key UniqueName                      : String(50);
        ...
        LineItems                       : Composition of many PurchaseOrder_LineItem_OP
                                              on LineItems.PurchaseOrder = $self;
...
entity PurchaseOrder_LineItem_OP : cuid {
    key PurchaseOrder                      : Association to PurchaseOrder_OP;
        ...
        SplitAccountings                   : Composition of many PurchaseOrder_LineItem_SplitAccountings_OP
