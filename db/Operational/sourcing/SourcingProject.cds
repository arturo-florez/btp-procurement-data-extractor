...
entity SourcingProject_OP : managed {
    ...
    key InternalId         : String(2000);
        ...
        SubContent         : Composition of many SourcingProject_SubContent_OP
                                 on SubContent.SourcingProject = $self;
        Client             : Composition of many SourcingProject_Client_OP
                                 on Client.SourcingProject = $self;
        Region             : Composition of many SourcingProject_Region_OP
                                 on Region.SourcingProject = $self;
        Commodity          : Composition of many SourcingProject_Commodity_OP
                                 on Commodity.SourcingProject = $self;


        Suppliers          : Composition of many SourcingProject_Suppliers_OP
