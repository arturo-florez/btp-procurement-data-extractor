...
entity SourcingRequest_OP : managed {
    ...
    key InternalId                  : String(2000);
        ...
        SubContent                  : Composition of many SourcingRequest_SubContent_OP
                                          on SubContent.SourcingRequest = $self;
        Client                      : Composition of many SourcingRequest_Client_OP
                                          on Client.SourcingRequest = $self;
        Region                      : Composition of many SourcingRequest_Region_OP
                                          on Region.SourcingRequest = $self;
        Commodity                   : Composition of many SourcingRequest_Commodity_OP
                                          on Commodity.SourcingRequest = $self;


        Suppliers                   : Composition of many SourcingRequest_Suppliers_OP
                                          on Suppliers.SourcingRequest = $self;
