...
entity DocumentTask_OP : managed {
    ...
    key InternalId              : String(50);
        ...
        Approver                : Composition of many DocumentTask_Approver_OP
                                      on Approver.DocumentTask = $self;
        ActiveApprover          : Composition of many DocumentTask_ActiveApprovers_OP
                                      on ActiveApprover.DocumentTask = $self;
        ApprovalRequests        : Composition of many DocumentTask_ApprovalRequests_OP
                                      on ApprovalRequests.DocumentTask = $self;
        Observer                : Composition of many DocumentTask_Observer_OP
                                      on Observer.DocumentTask = $self;
}

entity DocumentTask_Approver_OP : cuid {
    key DocumentTask : Association to DocumentTask_OP;
        Approver     : Composition of many DocumentTask_Approver_Approver_OP
                           on Approver.DocumentTaskApprover = $self;
}
...
entity DocumentTask_ApprovalRequests_OP : cuid {
    key DocumentTask     : Association to DocumentTask_OP;
        ...
        Approver         : Composition of many DocumentTask_ApprovalRequests_Approver_OP
                               on Approver.DocumentTaskApprovalRequests = $self;
