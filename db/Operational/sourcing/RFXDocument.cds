...
entity RFXDocument_OP : managed {
    ...
    key InternalId                   : String(100);
        ...
        Region                       : Composition of many RFXDocument_Region_OP
                                           on Region.RFXDocument = $self;
        Commodity                    : Composition of many RFXDocument_Commodity_OP
                                           on Commodity.RFXDocument = $self;
        Client                       : Composition of many RFXDocument_Client_OP
                                           on Client.RFXDocument = $self;
        Invitees                     : Composition of many RFXDocument_Invitees_OP
                                           on Invitees.RFXDocument = $self;
        RFXSupplierStatus            : Composition of many RFXDocument_RFXSupplierStatus_OP
                                           on RFXSupplierStatus.RFXDocument = $self;
