...
entity Organization_OP : managed {
    ...
    key SystemID         : String(64);
        ...
        BusinessContacts : Composition of many Organization_BusinessContacts_OP
                               on BusinessContacts.Organization = $self;
        Contacts         : Composition of many Organization_Contacts_OP
                               on Contacts.Organization = $self;
        Ids              : Composition of many Organization_OrganizationIds_OP
                               on Ids.Organization = $self;
        VendorKeys       : Composition of many Organization_VendorKeys_OP
                               on VendorKeys.Organization = $self;
