...
entity SLPSuppliers_SM : managed {
    ...
    key Realm                              : String(50);
        ...
        Qualifications                     : Composition of many SLPSuppliers_Qualifications_SM
                                                 on Qualifications.SLPSupplier = $self;
        Questionnaires                     : Composition of many SLPSuppliers_Questionnaires_SM
                                                 on Questionnaires.SLPSupplier = $self;
        RiskCategoryExposures              : Composition of many SLPSuppliers_RiskCategoryExposures_SM
                                                 on RiskCategoryExposures.SLPSupplier = $self;
        Certifications                     : Composition of many SLPSuppliers_Certificates_SM
                                                 on Certifications.SLPSupplier = $self;
